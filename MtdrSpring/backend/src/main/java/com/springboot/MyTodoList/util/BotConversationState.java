...
public enum BotConversationState {
    ...
    WAITING_EDIT_TASK_NEW_DESCRIPTION,
    WAITING_EDIT_TASK_NEW_SP,
    WAITING_EDIT_TASK_NEW_PRIORITY,
    WAITING_EDIT_TASK_NEW_SPRINT,
    // Feature creation flow
    WAITING_NEW_FEATURE_NAME,
    WAITING_NEW_FEATURE_DESCRIPTION,
    WAITING_NEW_FEATURE_PRIORITY,
    WAITING_NEW_FEATURE_SPRINT,
    // Feature edit flow
    WAITING_EDIT_FEATURE_FIELD,
    WAITING_EDIT_FEATURE_NEW_NAME,
    WAITING_EDIT_FEATURE_NEW_DESCRIPTION,
    WAITING_EDIT_FEATURE_NEW_PRIORITY,
    WAITING_EDIT_FEATURE_NEW_SPRINT,
    // Registration flow
